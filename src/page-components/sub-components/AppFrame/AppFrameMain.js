...
const AppFrameMain = () => {
    ...
    const mobilecategories = useSelector(state => state.SliceData.mobilecategories);
    // const saasclients = useSelector(state => state.SliceData.saasclients);
    const mobilepros = useSelector(state => state.SliceData.mobilepros);
    ...
    return (
        <>
            ...
            <div className="row app-service-icon">
            ...
            <div className="col-lg-12 new-quart px-0">
                ...
                <nav>
                    <div className="nav justify-content-start nav-tabs" id="nav-tab" role="tablist">
                      <button className="nav-lin active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">UX-UI Audits</button>
                      <button className="nav-lin" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Bug Fixing</button>
                      <button className="nav-lin" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Increase in Downloads</button>
                      <button className="nav-lin" id="nav-speed-tab" data-bs-toggle="tab" data-bs-target="#nav-speed" type="button" role="tab" aria-controls="nav-speed" aria-selected="false">Gamification</button>
